...
public class ProductServiceTest {
	...
	Product product = new Product(); // product.setProdNo(10008);
	product.setProdName("빼빼로");product.setProdDetail("과자");product.setPrice(500);product.setManuDate("111");product.setFileName("111");

	productService.addProduct(product);

	product=productService.getProduct(10014);System.out.println("================="+product);
	...
	Assert.assertEquals("과자",product.getProdDetail());
	Assert.assertEquals(500,product.getPrice());
	Assert.assertEquals("111",product.getManuDate());
	Assert.assertEquals("111",product.getFileName());
